...
class Procedure(models.Model):
	...
	steps = ArrayField(models.CharField(max_length=50, null=True,blank=False, default=""), size=15 )
...
class Law(models.Model):
	...
	title = models.CharField(max_length=200)
	summary = models.CharField(max_length=1000)
	bullets = ArrayField(models.CharField(max_length=50, null=True,blank=False, default=""), size=15)
